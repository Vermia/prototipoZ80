...
Hexadecimal [16-Bits]
                              ...
                              4 .area _DATA
   4219                       5     PlayerSprite::
   4219 33 CC                 6         .db     #0x33 , #0xCC 
   421B 77 EE                 7         .db     #0x77 , #0xEE 
   421D 11 88                 8         .db     #0x11 , #0x88 
   421F F0 F0                 9         .db     #0xF0 , #0xF0 
   4221 BB DD                10         .db     #0xBB , #0xDD 
   4223 BB DD                11         .db     #0xBB , #0xDD 
   4225 0A 55                12         .db     #0x0A , #0x55 
   4227 22 44                13         .db     #0x22 , #0x44 
   4229 22 44                14         .db     #0x22 , #0x44 
   422B 66 66                15         .db     #0x66 , #0x66 
                             16 
                             17 
                             18 
                             19 
